...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        ShiroUser shiroUser = new ShiroUser(user.getId(), user.getUserName(), user.getName(), urls,user.getDepartmentId());
        shiroUser.setRoles(roles);
        // 认证缓存信息
        return new SimpleAuthenticationInfo(shiroUser, user.getUserPassword().toCharArray(), getName());
    }
