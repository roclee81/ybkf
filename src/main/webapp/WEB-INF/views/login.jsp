...
<!-- 这里是标题LOGO -->
<div style="margin-top: 3%;margin-left:4.5%;" id=logologo><img  width="100%" src="${staticPath }/static/style/images/logo-3.png"></img></div>
<!-- <div class="top_div"></div> -->
<!-- 这里是登录框 -->
<div id="loginBox"  style="margin:90px auto auto auto;width: 37.5%;border-radius: 4px;box-shadow:0px 5px 25px rgba(114, 156, 203,0.59 )">
<div  style="margin:0px 0px 0px 0px; width:100%;height:100%; padding-top: 1px;padding-bottom:30px;text-align: center;">
    <form method="post" id="loginform">
        ...
        <P style="position: relative; margin-top:40px; ">
            <p align="left" style="margin-bottom:10px;padding-left:25%;font-size: 1.4em;font-weight: bold;font-style:'Microsoft YaHei'; color: #4C9CF3;">用户名</p>
            <input class="ipt" type="text" style="width:40%;padding-left:10%" name="username" placeholder="请输入用户名或邮箱"/>
        </P>
        <P style="position: relative; margin-top:10px;">
            <p align="left" style="padding-left:25%;font-size: 1.4em;font-weight: bold;font-style:'Microsoft YaHei'; color: #4C9CF3;">密码</p>
            <input class="ipt"  style="width:40%;padding-left:10%" id="password" type="password" name="password" placeholder="请输入密码"/>
        </P>
 <!--<P style="position: relative; margin-top:10px; ">
        ...
        <p align="left" style="position: relative; margin-top:10px;color:#A4A4A4;">
        	<input class="rememberMe" type="checkbox" name="rememberMe" value="1" style="vertical-align:middle;margin-left:25%;height:20px;"/> 记住密码</p> 
			<div  class="mp"style="margin-top: -5%;color: #EF2222;margin-left: 60px;font-size: 14px;line-height: 20px;"><img style="display: none;width: 4%;height: 4%;" id='errimg' src="${staticPath }/static/style/images/remind.png"><span id='errmsg' style='margin-left: 15px;'></span></div>
        <P style="position: relative; margin-top:10px; text-align: left;">
        </P>
        <div id='loginbutton' style="margin-left:25%;position: relative; width:52%;height:23px;background-color: #0068b7;font-size: 1.2em;color: white; cursor:pointer;background:-webkit-gradient(linear, 0% 0%, 0% 100%,from(#6AB1FF), to(#409BFF));border-radius:4px;" onclick="submitForm()">登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录</div>
...
<div id='footfoot'><img width="100%"  src="${staticPath }/static/style/images/footfoot.png"></div>
</body>
<script>
	if($("#loginBox").parent().width()<700){
		$("#logologo,#footfoot").find("img").css({"width":"200%"});
		$(".mp").css({"marginTop":"0"});
		$("#loginBox").css({"width":"67%"});
	}	 
</script>
</html>