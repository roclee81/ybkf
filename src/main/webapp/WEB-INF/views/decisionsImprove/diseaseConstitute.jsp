...
<div class="header-div bg-color margin-top10">
    <table class="ys-table tiaojian margin-left20" style="width: 95%">
        ...
        <tr>
            ...
            <td class="padding-left20" style="width:140px; text-align:left;">
                <input type="radio" id="monthly" name='an' checked style="height:12px; margin-right:5px;" /><span>按月度</span>
                <input type="radio" id="quarter" name='an' style="height:12px; margin-right:5px;margin-left: 5px" /><span>按季度</span>
            </td>
            <td style="width:60px">
            	<div class="ennd fs_16 padding-left20">
                ...
                <div class="roop fs_16 padding-left20" style="display:none">
                	<select style="width: 46px">
                        <option value="0">01</option>
                        <option value="2">02</option>
            ...
            <td class="td-width fs_16 padding-left20" >
                科室
            </td>
            <td>
...
<div class="zy-div2 bg-color margin-top10">
    ...
    <div class="gauge-title-div">
        <table class="body-width">
            <tr>
                <td>
                    <div class="tab-tables-l" style="padding-left: 1%">
                        <ul class="tab1s">
                            <li class="on padding-left0 margin-left0">疾病收治人次排名TOP30</li>
                            <li>疾病收治人次环比增长幅度排名TOP30</li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                </td>
    ...
    <div class="tab-table-box1s">
                ...
                <div class="gauge-div float" style="width:38%; margin-top:0;">
                    <div class="ks-fy-zb">
                        <div class="gauge-title-div">
                            <table class="body-width">
                                <tr>
                                    <td class="left fs_16 table-title ">疾病费用构成</td>
                                    <td class="right fs_16">
                                        <button class="btn btn-sm btn-primary"><img src="${staticPath }/static/img/menu/btn1-icon.png">导出</button>
                                    </td>
                                </tr>
        ...
        <div class="ks-fy-zb" >
            ...
            <div class="ks-fy-zb" style="padding-bottom: 0">
                ...
                <div class="module-hr"></div>    
        <div class="tab-table-box bg-color margin-top10" style="display:none" id="tab-pox">
            <div class="tab-div-box">
               ...
               <div class="yb-jj-div float"  style="width:60%; margin-left:1%;">
                    ...
                    <div class="ys-rc-div" style="border-right:1px solid #E4F1FD">
                        <table class="body-width common-table" id='common1'>
                            <tbody>
                            <tr class="th-bg">
                                <th>患者ID</th>
                                <th>患者姓名</th>
            ...
            <div class="module-hr"></div>
            <div class="yb-jj-div margin-top10 bg-color" style="padding:10px; display:none" id="ore1">
            	<div class="float tab-div" style="width: 80%;">
                    <div class="tab-div-menu jb-ul-li">
                        <ul class="ul-style" id="ul-two2">
                            <li>
                                <label class="x-on" style="margin-left: -2px">医嘱明细</label>
                            </li>
                            <li>
                ...
                <div class="clear"></div>
                <div class="tab-div-box1 border-val" id="gw2" style="margin-bottom: 2px; padding-bottom:10px;">
                	<!--医嘱明细-->
                    <div>
                        <div class="yb-jj-div">
                            <div class="ys-rc-div margin-top20">
...
$("radio").on({
    "change":function(){
        var index= $('#scr option:selected').index();
        if(index==0){
            $('.ennd').css('display','block');
            $('.roop').css('display','none');
        }else{
            $('.ennd').css('display','none');
            $('.roop').css('display','block');
        }
    }
});*/
...
$(".tab1s li").click(function () {
	...
	if (index == 0) {
		...
		$("#ore").css("display","none");
	}
	else if (index == 1){
		bar3();
		$("#tab-pox").css("display","none");
...
$("#ul-two2 li").click(function () {
	//切换选中的按钮高亮状态
	
	var index = $(this).index();
	$("#ul-two2 li").eq(index).find('label').addClass("x-on");
	
	$("#ul-two2 li").eq(index).siblings().children().removeClass("x-on");

	//获取被按下按钮的索引值，需要注意index是从0开始的
	$("#gw2 > div").eq(index).show().siblings().hide();
});

$("#common a").click(function(){
	$("#ore").css("display","block");
	});
$("#common1 a").click(function(){
	$("#ore1").css("display","block");
	});
		...
		xAxis: [
			{
				...
				data: ['股骨颈骨折', '恶性淋巴瘤', '腰椎骨折', '糖尿病', '急性会厌炎', '高血压','冠心病', '胸闷', '腹痛', '慢性支气管炎', '哮喘', '慢性胃炎', '神经衰弱', '甲亢', '红斑狼疮','心肌炎', '心绞痛', '湿疹', '麻风病', '银屑病', '肝结核','结膜炎', '眶底骨折', '反向斜视', '巩膜炎', '鼻息肉', '喉炎', '枯草热', '扁桃体炎', '怔忡'],
				axisLabel: {
					textStyle: {
						color: '#333333'
					},
		...
		series: [
			{
				...
				barWidth: 12,
				barGap: 0.1,
				data: [970, 940, 910, 880, 850, 820,790,760,730,700,670,640,610,580,550,520,490,460,430,400,370,340,310,280,250,220,190,160,130,100]
			}
		]
	};
	// 使用刚指定的配置项和数据显示图表。
...
function linen2(){
    // 耗材-饼图1
    var myChartPie1 = echarts.init(document.getElementById('zy_Gauge2'));
    // 指定图表的配置项和数据
    optionPie1 = {
        tooltip: {
            trigger: 'item',
