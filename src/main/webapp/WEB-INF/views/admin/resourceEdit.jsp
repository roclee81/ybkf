        ...
        <table  class="grid">
            <tr>
                ...
                <td>
                    ...
                    <input name="name" type="text" placeholder="请输入资源名称" value="${menu.name}" class="easyui-validatebox span2" data-options="required:true" >
                </td>
            </tr>
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" value="${menu.url}" placeholder="请输入资源路径" class="easyui-validatebox span2" ></td>
                <td>打开方式</td>
                <td>
            ...
            <tr>
                <td>菜单图标</td>
                <td><input name="icon" value="${menu.icon}"/></td>
                <td>排序</td>
                <td><input name="seq" value="${menu.seq}" class="easyui-numberspinner" style="width: 140px; height: 29px;" required="required" data-options="editable:false"></td>
            </tr>
            <tr>
                <td>状态</td>
                <td>
